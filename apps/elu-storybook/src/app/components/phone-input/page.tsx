...
import {
  PhoneInput,
  PhoneInputSkeleton,
} from '@eluelu/elu-ui/components/phone-input';
    ...
    <div className="mx-auto max-w-5xl space-y-12">
      <div>
        ...
        <Typography color="muted" variant="p">
          以 libphonenumber-js 驗證的國際電話輸入欄位，支援國碼選擇、圓角樣式與錯誤顯示。
        </Typography>
      </div>
      ...
      <div className="rounded-lg border bg-muted/20 p-4">
        ...
        <Typography color="muted" variant="xs">
          Phone Input 會根據瀏覽器語系推測預設國際碼；當使用者輸入完整的國際電話（含 + 國碼）時，元件會自動更新對應國別並回傳最新的 E.164 格式。
        </Typography>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              ...
              <tr>
                ...
                <td className="px-4 py-2">輸入框圓角樣式（目前僅支援標準與無圓角）</td>
              </tr>
              <tr>
      ...
      <div className="bg-muted/30 mt-12 space-y-4 rounded-lg border p-6">
        ...
        <pre className="overflow-x-auto rounded-md bg-black p-4 text-sm text-white">
          <code>{`import { PhoneInput } from "@eluelu/elu-ui/components/phone-input";
      ...
      >
        <div className="flex w-full max-w-xl flex-col gap-4">
          <PhoneInput
            ...
            value={basicValue}
          />
          <div className="grid gap-2 rounded-md bg-muted/30 p-4 text-sm">
